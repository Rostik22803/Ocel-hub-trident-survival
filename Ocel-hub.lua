...
local Translations = {
    ...
    ["Bow"] = "Лук",
    ["AR15"] = "AR-15",
    ["AdminMinigun"] = "Админ Миниган",
    ["Bandage"] = "Бинт",
    ["Beans"] = "Бобы",
    ["BloxyCola"] = "Блокси Кола",
    ["Blunderbuss"] = "Мушкетон",
    ["C4"] = "C4",
    ["C9"] = "C9",
    ["ClimbingPick"] = "Ледоруб",
    ["CrossBow"] = "Арбалет",
    ["Crowbar"] = "Монтировка",
    ["Dynamite"] = "Динамит",
    ["EnergyRifle"] = "Энерго-винтовка",
    ["FlameThrower"] = "Огнемет",
    ["Flare"] = "Файер",
    ["Flashgrenade"] = "Светошумовая",
    ["GaussRifle"] = "Винтовка Гаусса",
    ["Glowstick"] = "Химсвет",
    ["Grenade"] = "Граната",
    ["HMAR"] = "HMAR",
    ["HMCharge"] = "Самодельный заряд",
    ["Hammer"] = "Молоток",
    ["HealingBandage"] = "Лечебный бинт",
    ["IronHammer"] = "Железный молот",
    ["KABAR"] = "Нож KABAR",
    ["LeverActionRifle"] = "Винтовка со скобой",
    ["M4A1"] = "M4A1",
    ["MedSerum"] = "Мед. сыворотка",
    ["Minigun"] = "Миниган",
    ["MiningDrill"] = "Бур",
    ["Molotov"] = "Молотов",
    ["PipePistol"] = "Самопал пистолет",
    ["PipeSMG"] = "Самопал ПП",
    ["PumpShotgun"] = "Помповый дробовик",
    ["RPG"] = "РПГ",
    ["RiotShield"] = "Штурмовой щит",
    ["SCAR"] = "SCAR",
    ["SVD"] = "СВД",
    ["StelHammer"] = "Стальной молот",
    ["StoneHammer"] = "Каменный молот",
    ["USP9"] = "USP9",
    ["UZI"] = "Узи",
...
local function Translate(text)
    if CurrentLanguage == "RU" and Translations[text] then
...
function OcelUI:CreateWindow(options)
    ...
    function Window:CreateTab(name, icon)
        ...
        function Tab:CreateDropdown(dOpts)
            ...
            -- Simple logic to allow selection for language dropdown
            local Btn = Instance.new("TextButton")
            Btn.Parent = DdFrame
            Btn.Size = UDim2.new(1, 0, 1, 0)
            Btn.BackgroundTransparency = 1
            ...
            local clickIndex = 1
            Btn.MouseButton1Click:Connect(function()
                if dOpts.Options and #dOpts.Options > 0 then
                    clickIndex = clickIndex + 1
                    if clickIndex > #dOpts.Options then clickIndex = 1 end
                    local selected = dOpts.Options[clickIndex]
                    Label.Text = dOpts.Name .. " [" .. selected .. "]"
...
-- [ADDED] Выбор языка перевода
l_l_v0_Window_0_Tab_1:CreateSection("Language / Язык");
l_l_v0_Window_0_Tab_1:CreateDropdown({
    ...
    Callback = function(opt)
        ...
        CurrentLanguage = opt == "Русский" and "RU" or "EN"
    end
});
...
local v31 = true;
local v32 = false;
local vNameESP = false; -- [ADDED] Name ESP Toggle Variable
...
l_l_v0_Window_0_Tab_1:CreateToggle({
    ...
    CurrentValue = false, 
    Flag = "BoxEspToggle", 
    Callback = function(v37) ToggleBoxes(v37); end
});
l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Name Esp", -- [ADDED] Кнопка включения ESP Никнеймов
    CurrentValue = false, 
    Flag = "NameEspToggle", 
    Callback = function(val) ToggleNameESP(val); end
});
l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Distance Esp", 
    CurrentValue = false, 
    Flag = "DistanceEspToggle", 
    Callback = function(v38) ToggleDistance(v38); end
});
l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Player/Bot Esp", 
    CurrentValue = false, 
    Flag = "BotEspToggle", 
    Callback = function(v39) ToggleType(v39); end
});
l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Sleeper Check", 
    CurrentValue = false, 
    Flag = "SleeperCheckToggle", 
    Callback = function(v40) ToggleSleeperCheck(v40); end
});
l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Weapon Esp", 
    CurrentValue = false, 
    Flag = "WeaponEspToggle", 
    Callback = function(v41) ToggleWeaponESP(v41); end
});
l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Skeleton Esp", 
    CurrentValue = false, 
    Flag = "SkeletonEspToggle", 
    Callback = function(v42) ToggleSkeletonESP(v42); end
});
l_l_v0_Window_0_Tab_1:CreateColorPicker({
    Name = "Box Color", 
    Color = Color3.fromRGB(255, 255, 255), 
    Flag = "BoxColorPicker1", 
    Callback = function(v43) v33 = v43; end
});
l_l_v0_Window_0_Tab_1:CreateColorPicker({
    Name = "Skeleton Color", 
    Color = Color3.fromRGB(255, 255, 255), 
    Flag = "SkeletonColorPicker1", 
    Callback = function(v44) v35 = v44; end
});
l_l_v0_Window_0_Tab_1:CreateColorPicker({
    Name = "Text Color", 
    Color = Color3.fromRGB(255, 255, 255), 
    Flag = "TextColorPicker1", 
    Callback = function(v45) v34 = v45; end
});
local v46 = {
    {"Head", "Torso"}, {"Torso", "LeftUpperArm"}, {"LeftUpperArm", "LeftLowerArm"}, 
    {"Torso", "RightUpperArm"}, {"RightUpperArm", "RightLowerArm"}, {"LowerTorso", "LeftUpperLeg"}, 
    {"LeftUpperLeg", "LeftLowerLeg"}, {"Torso", "LowerTorso"}, {"RightUpperLeg", "RightLowerLeg"}, 
    {"LowerTorso", "RightUpperLeg"}, {"LeftLowerLeg", "LeftFoot"}, {"RightLowerLeg", "RightFoot"}, 
    ...
    if v25[v66] then
        ...
        if not v67 or not v68 then
            ...
            for _, v75 in ipairs(v46) do
                ...
                v76.Thickness = 1.5;
                v76.Visible = false;
                table.insert(v73, {line = v76, a = v75[1], b = v75[2]});
            end;
            ...
            v66.Destroying:Connect(function() 
                ...
                for _, v78 in ipairs(v73) do
                    do
                        local l_v78_0 = v78;
                        pcall(function() l_v78_0.line:Remove(); end);
                    end;
                end;
                v25[v66] = nil;
            end);
...
ToggleESP = function(v85) v26 = v85; end;
ToggleBoxes = function(v86) v29 = v86; end;
ToggleNameESP = function(val) vNameESP = val; end; -- [ADDED] Функция переключателя Name ESP
ToggleDistance = function(v87) v27 = v87; end;
ToggleType = function(v88) v28 = v88; end;
ToggleSleeperCheck = function(v89) v30 = v89; end;
ToggleWeaponESP = function(v90) v31 = v90; end;
ToggleSkeletonESP = function(v91) v32 = v91; end;
SetESPColor = function(v92) v33 = v92; end;
    ...
    if not v26 then
        ...
        for v94, v95 in pairs(v25) do
            ...
            if not v96 then
                ...
                -- [ADDED] Логика вывода имени
                if vNameESP then
                    local plr = game:GetService("Players"):GetPlayerFromCharacter(v94)
                    local name = plr and plr.Name or v94.Name
                    table.insert(v117, name) -- Добавляем имя, не пропуская его через функцию перевода
                end
                
                if v28 then
                    -- [MODIFIED] Использование функции перевода
                    table.insert(v117, v55(v94) and Translate("Player") or Translate("Bot"));
                end;
                if v27 then
                ...
                if v31 then
                    ...
                    -- [MODIFIED] Перевод названия оружия
                    v95.weaponText.Text = Translate(v119);
...
ToggleESP(true); ToggleBoxes(false); ToggleDistance(false); ToggleType(false);
ToggleSleeperCheck(false); ToggleWeaponESP(false); ToggleSkeletonESP(false); ToggleNameESP(false);
...
G2L["2"].ZIndex = -8; G2L["2"].BackgroundColor3 = Color3.fromRGB(31, 31, 31);
G2L["2"].Size = UDim2.new(0, 786, 0, 77); G2L["2"].Position = UDim2.new(0.3, 1, 0, -30);
G2L["2"].BorderColor3 = Color3.fromRGB(11, 11, 11); G2L["2"].Name = "Armor"; G2L["2"].BackgroundTransparency = 1;
G2L["4"] = Instance.new("TextLabel", G2L["2"]);
G2L["4"].ZIndex = 3; G2L["4"].BorderSizePixel = 0; G2L["4"].TextSize = 20;
G2L["4"].BackgroundColor3 = Color3.fromRGB(255, 255, 255);
G2L["4"].FontFace = Font.new("rbxasset://fonts/families/Zekton.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal);
G2L["4"].TextColor3 = Color3.fromRGB(255, 255, 255); G2L["4"].BackgroundTransparency = 1;
G2L["4"].Size = UDim2.new(0, 219, 0, 16); G2L["4"].BorderColor3 = Color3.fromRGB(0, 0, 0);
G2L["4"].Text = "Armor"; G2L["4"].Name = "Section"; G2L["4"].Position = UDim2.new(0.34987, 0, -7.5E-4, 0);
G2L["5"] = Instance.new("Frame", G2L["2"]);
G2L["5"].ZIndex = 2; G2L["5"].BackgroundColor3 = Color3.fromRGB(31, 31, 31);
G2L["5"].Size = UDim2.new(0, 786, 0, 81); G2L["5"].BorderColor3 = Color3.fromRGB(255, 255, 255);
G2L["5"].Name = "Back"; G2L["5"].BackgroundTransparency = 0.4;
G2L["6"] = Instance.new("Frame", G2L["2"]);
G2L["6"].BackgroundColor3 = Color3.fromRGB(31, 31, 31); G2L["6"].Size = UDim2.new(0, 788, 0, 83);
G2L["6"].Position = UDim2.new(0, -1, 0, -1); G2L["6"].BorderColor3 = Color3.fromRGB(0, 0, 0);
G2L["6"].Name = "Front"; G2L["6"].BackgroundTransparency = 0.4;
local l_2_0 = G2L["2"];
local _ = game:GetService("UserInputService");
local v133 = false; local v134 = nil; local v135 = nil;
l_2_0.InputBegan:Connect(function(v136, v137) 
    if v137 then return; else
        if v136.UserInputType == Enum.UserInputType.MouseButton1 or v136.UserInputType == Enum.UserInputType.Touch then
            v133 = true; v134 = v136.Position; v135 = l_2_0.Position;
            v136.Changed:Connect(function() 
                if v136.UserInputState == Enum.UserInputState.End then v133 = false; end;
            end);
        end; return;
    end;
end);
l_2_0.InputChanged:Connect(function(v138) 
...
local function v145(v140, v141) 
    ...
    v142.BackgroundTransparency = 1; v142.Parent = G2L["1"];
end;
local v146 = Drawing.new("Circle");
v146.Visible = false; v146.Thickness = 1.5; v146.Radius = 150;
v146.Color = Color3.fromRGB(0, 255, 0); v146.Filled = false;
local v147 = Drawing.new("Line");
v147.Visible = false; v147.Thickness = 1.5; v147.Color = Color3.fromRGB(255, 0, 0);
local v148 = nil; local v149 = 0; local v150 = 1; local v151 = false; local v152 = 220;
local _ = l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Armor Esp", CurrentValue = false, Flag = "Toggle1", 
    Callback = function(v153) 
        v151 = v153;
        if not v153 then
            for _, v155 in ipairs(screenGui:GetChildren()) do
                if v155:IsA("ViewportFrame") then v155:Destroy(); end;
            end;
        end;
    end
});
local _ = l_l_v0_Window_0_Tab_1:CreateSlider({
    Name = "Fov Slider", Range = {10, 500}, Increment = 1, Suffix = "Size", 
    CurrentValue = 220, Flag = "Slider1", 
    Callback = function(v157) v152 = v157; v146.Radius = v157; end
});
local function v167() 
    local v159 = nil; local l_huge_0 = math.huge;
        ...
        if v163:IsA("Model") and v163:FindFirstChild("Head") and v163:FindFirstChild("Armor") then
            ...
            if v165 then
                ...
                if l_Magnitude_0 <= v152 and l_Magnitude_0 < l_huge_0 then
                    l_huge_0 = l_Magnitude_0; v159 = v163;
                end;
            end;
        end;
    end; return v159;
...
l_RunService_0.RenderStepped:Connect(function() 
    ...
    v149 = v149 + 1;
    if v149 < v150 then return; else
        v149 = 0;
        if not v151 then
            v147.Visible = false; v148 = nil; return;
        else
            local v168 = v167();
            if v168 then
                ...
                if v170 then
                    ...
                    if v168 ~= v148 then
                        ...
                        for _, v172 in ipairs(G2L["1"]:GetChildren()) do
                            if v172:IsA("ViewportFrame") then v172:Destroy(); end;
                        end;
                        if v168:FindFirstChild("Armor") then
                            local v173 = 10;
                            for _, v175 in ipairs(v168.Armor:GetChildren()) do
                                local v176 = armorMapping[v175.Name];
                                if v176 then v145(v176, v173); v173 = v173 + 130; end;
                            end;
                        end;
                    end;
                else
                    v147.Visible = false; v148 = nil;
                end;
            else
                v147.Visible = false; v148 = nil;
            end;
...
local function v180(v177, v178) 
    local v179 = Drawing.new("Text");
    v179.Text = v177; v179.Size = 16; v179.Center = true;
    v179.Outline = true; v179.OutlineColor = Color3.new(0, 0, 0);
    v179.Color = v178; v179.Visible = false;
    return v179;
end;
ItemESP = {}; ItemESP_Enabled = false; itemFrameCounter = 0;
local function v187(v181) 
    if ItemESP[v181] then return; else
        ...
        if not l_Union_0 or not l_Display_0 or not l_Part_0 then return; else
            local v185 = l_Union_0 or l_Display_0 or l_Part_0;
            local v186 = v180("Item", Color3.new(1, 1, 0));
            ItemESP[v181] = {drawing = v186, part = v185};
            return;
        end;
    end;
end;
local function v190() 
    if not ItemESP_Enabled then return; else
        for _, v189 in ipairs(l_Workspace_0:GetChildren()) do
            if v189:IsA("Model") then v187(v189); end;
        end; return;
    end;
end;
local function v193() 
    for _, v192 in pairs(ItemESP) do v192.drawing:Remove(); end;
    ItemESP = {};
end;
CorpseESP = {}; CorpseESPEnabled = false;
local function v200(v194) 
    local v195 = {};
    for _, v197 in ipairs(v194:GetChildren()) do
        if v197:IsA("BasePart") then table.insert(v195, v197); end;
    end;
    if #v195 ~= 2 then return false; else
        local l_Material_0 = v195[1].Material; local l_Material_1 = v195[2].Material;
...
local function v203(v201) 
    if CorpseESP[v201] then return; else
        local v202 = v180("Corpse", Color3.fromRGB(255, 0, 0));
        CorpseESP[v201] = {drawing = v202, model = v201};
        v201.Destroying:Connect(function() 
            v202:Remove(); CorpseESP[v201] = nil;
        end); return;
    end;
end;
local function v206() 
    for _, v205 in ipairs(l_Workspace_0:GetChildren()) do
        if v205:IsA("Model") and v200(v205) then v203(v205); end;
    end;
end;
l_Workspace_0.ChildAdded:Connect(function(v207) 
    if v207:IsA("Model") and v200(v207) then v203(v207); end;
end);
RaidESP = {}; RaidESP_Enabled = false;
hitSoundNames = {Explosion = true, Explosion_Muffled = true};
local function v210(v208) 
    v208.Played:Connect(function() 
        local v209 = v208.Parent and v208.Parent.Position;
        if v209 then
            table.insert(RaidESP, {text = v180("Raid", Color3.fromRGB(255, 0, 0)), position = v209, startTime = tick()});
        end;
    end);
end;
...
for _, v215 in l_ipairs_0(l_Workspace_0[v212](l_l_Workspace_0_0)) do
    if v215:IsA("Sound") and hitSoundNames[v215.Name] then v210(v215); end;
end;
l_Workspace_0.DescendantAdded:Connect(function(v216) 
    if v216:IsA("Sound") and hitSoundNames[v216.Name] then v210(v216); end;
end);
AirdropESP = {}; AirdropESP_Enabled = false;
l_ipairs_0 = function(v217) 
    if not v217 or not v217.Parent then return; else
        local v218 = v217:FindFirstChild("Crates") or v217:FindFirstChild("Cables");
        if not v218 then return; else
            if not AirdropESP[v217] then
                local v219 = v180("Airdrop", Color3.fromRGB(255, 255, 0));
                AirdropESP[v217] = {drawing = v219, part = v218};
            end; return;
        end;
    end;
end;
local function v222() 
    for _, v221 in pairs(AirdropESP) do v221.drawing:Remove(); end;
    AirdropESP = {};
end;
l_RunService_0.RenderStepped:Connect(function() 
    if ItemESP_Enabled then
        itemFrameCounter = itemFrameCounter + 1;
        if itemFrameCounter >= 10 then v190(); itemFrameCounter = 0; end;
        for v223, v224 in pairs(ItemESP) do
            if v224.part and v224.part.Parent then
                ...
                -- [MODIFIED] Динамический перевод Items ESP
                v224.drawing.Text = Translate("Item")
                if v226 then v224.drawing.Position = Vector2.new(v225.X, v225.Y - 20); end;
            else
                v224.drawing:Remove(); ItemESP[v223] = nil;
            end;
        end;
    end;
    if CorpseESPEnabled then
        for v227, v228 in pairs(CorpseESP) do
            ...
            if v229 then
                ...
                -- [MODIFIED] Динамический перевод Corpse
                v228.drawing.Text = Translate("Corpse")
                if v231 then v228.drawing.Position = Vector2.new(v230.X, v230.Y - 20); end;
            else
                v228.drawing.Visible = false;
            end;
        end;
    else
        for _, v233 in pairs(CorpseESP) do v233.drawing.Visible = false; end;
    end;
    if RaidESP_Enabled then
        for v234 = #RaidESP, 1, -1 do
            ...
            if v236 > 300 then
                v235.text:Remove(); table.remove(RaidESP, v234);
            else
                ...
                if v238 then
                    ...
                    -- [MODIFIED] Динамический перевод Raid
                    v235.text.Text = Translate("Raid") .. " | " .. v239 .. " | " .. math.floor(v236);
    ...
    if AirdropESP_Enabled then
        for _, v241 in ipairs(l_Workspace_0:GetChildren()) do
            if v241:IsA("Model") then l_ipairs_0(v241); end;
        end;
        for v242, v243 in pairs(AirdropESP) do
            if not v242 or not v242.Parent then
                v243.drawing:Remove(); AirdropESP[v242] = nil;
            else
                local v244, v245 = l_CurrentCamera_0:WorldToViewportPoint(v243.part.Position);
                v243.drawing.Visible = v245;
                -- [MODIFIED] Динамический перевод Airdrop
                v243.drawing.Text = Translate("Airdrop")
                if v245 then v243.drawing.Position = Vector2.new(v244.X, v244.Y - 20); end;
            end;
        end;
    end;
end);
l_l_Workspace_0_0 = l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Item ESP", CurrentValue = false, Flag = "ToggleItemESP", 
    Callback = function(v246) ItemESP_Enabled = v246; if v246 then v190(); else v193(); end; end
});
v212 = l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Corpse ESP", CurrentValue = false, Flag = "ToggleCorpseESP", 
    Callback = function(v247) CorpseESPEnabled = v247; if v247 then v206(); end; end
});
local _ = l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Raid ESP", CurrentValue = false, Flag = "ToggleRaidESP", 
    Callback = function(v248) 
        RaidESP_Enabled = v248;
        if not v248 then for _, v250 in pairs(RaidESP) do v250.text:Remove(); end; RaidESP = {}; end;
    end
});
local _ = l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Airdrop ESP", CurrentValue = false, Flag = "ToggleAirdropESP", 
    Callback = function(v252) AirdropESP_Enabled = v252; if not v252 then v222(); end; end
});
local _ = l_l_v0_Window_0_Tab_1:CreateSection("Ore Esp");
local _ = l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Stone Esp", CurrentValue = false, Flag = "StoneToggle", Callback = function(v255) ESP_ENABLED.Stone = v255; end
});
local _ = l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Iron Esp", CurrentValue = false, Flag = "IronToggle", Callback = function(v257) ESP_ENABLED.Iron = v257; end
});
local _ = l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Nitrate Esp", CurrentValue = false, Flag = "NitrateToggle", Callback = function(v259) ESP_ENABLED.Nitrate = v259; end
});
local _ = l_l_v0_Window_0_Tab_1:CreateToggle({
    Name = "Show Distance", CurrentValue = false, Flag = "ShowDistanceToggle", Callback = function(v261) ESP_ENABLED.ShowDistance = v261; end
});
local _ = l_l_v0_Window_0_Tab_1:CreateSlider({
    Name = "Ore Distance Esp", Range = {10, 1000}, Increment = 1, Suffix = "m", CurrentValue = 750, Flag = "DistanceSlider", Callback = function(v263) renderDistance = v263; end
});
...
ESP_ENABLED = {Stone = false, Iron = false, Nitrate = false, ShowDistance = false};
oreESP = {}; renderDistance = 750;
local v269 = {
...
local function v281(v274) 
    ...
    for _, v277 in ipairs(v274:GetChildren()) do
        if v277:IsA("MeshPart") then table.insert(v275, v277); end;
    end;
    if #v275 == 1 then
        local l_Color_0 = v275[1].Color;
        if v273(l_Color_0, v269.Stone[1]) then return "Stone", v275[1]; end;
    elseif #v275 == 2 then
        local l_Color_1 = v275[1].Color; local l_Color_2 = v275[2].Color;
        ...
        elseif v273(l_Color_1, v269.Nitrate[1]) and v273(l_Color_2, v269.Nitrate[2]) or v273(l_Color_1, v269.Nitrate[2]) and v273(l_Color_2, v269.Nitrate[1]) then return "Nitrate", v275[1]; end;
    end; return nil;
end;
local function v286(v282, v283, v284) 
    local v285 = Drawing.new("Text");
    v285.Text = v283; v285.Size = 16; v285.Center = true; v285.Outline = true; v285.Color = v270[v283]; v285.Visible = true;
    oreESP[v282] = {Text = v285, OreType = v283, Part = v284};
end;
local function v288(v287) 
    if oreESP[v287] then oreESP[v287].Text:Remove(); oreESP[v287] = nil; end;
end;
task.spawn(function() 
    while true do
        for _, v290 in ipairs(l_Workspace_1:GetChildren()) do
            if v290:IsA("Model") and not oreESP[v290] then
                ...
                if v291 and ESP_ENABLED[v291] then v286(v290, v291, v292); end;
            end;
        end;
        for v293 in pairs(oreESP) do
            if not v293.Parent then v288(v293); end;
        end;
        task.wait(2);
    end;
end);
l_RunService_1.RenderStepped:Connect(function() 
    for v294, v295 in pairs(oreESP) do
        ...
        if l_Part_1 and l_Part_1.Parent then
            ...
            if v299 and l_Magnitude_1 <= renderDistance and ESP_ENABLED[v295.OreType] then
                ...
                -- [MODIFIED] Использование функции перевода руды
                if ESP_ENABLED.ShowDistance then
                    l_Text_0.Text = string.format("%s | %.0fm", Translate(v295.OreType), l_Magnitude_1);
                else
                    l_Text_0.Text = Translate(v295.OreType);
                end;
...
VehicleBlueprints = {ATV = l_vehicles_0.ATV.Model, Boat = l_vehicles_0.Boat.Model, Helicopter = l_vehicles_0.Helicopter.Model, Trolly = l_vehicles_0.Trolly.Model};
VehicleESP = {}; EspEnabled = {ATV = false, Boat = false, Helicopter = false, Trolly = false}; DistanceESPEnabled = false;
local function v310(v306, v307) 
    for _, v309 in ipairs(v307:GetChildren()) do if not v306:FindFirstChild(v309.Name) then return false; end; end; return true;
end;
local function v314(v311, v312) 
    local v313 = Drawing.new("Text"); v313.Size = 18; v313.Color = Color3.fromRGB(0, 255, 0); v313.Center = true; v313.Outline = true; v313.Visible = true;
    VehicleESP[v311] = {Drawing = v313, Name = v312};
end;
local function v316(v315) 
    if VehicleESP[v315] then VehicleESP[v315].Drawing:Remove(); VehicleESP[v315] = nil; end;
end;
local v317 = 0; local v318 = 500;
        ...
        for _, v320 in ipairs(workspace:GetChildren()) do
            if v320:IsA("Model") and not VehicleESP[v320] then
                for v321, v322 in pairs(VehicleBlueprints) do
                    if EspEnabled[v321] and v310(v320, v322) then v314(v320, v321); break; end;
                end;
            end;
        end;
        for v323, _ in pairs(VehicleESP) do if not v323.Parent then v316(v323); end; end;
    end;
    for v325, v326 in pairs(VehicleESP) do
        local l_Drawing_0 = v326.Drawing; local l_Name_0 = v326.Name;
        if EspEnabled[l_Name_0] and v325.PrimaryPart then
            ...
            if v330 then
                ...
                -- [MODIFIED] Использование функции перевода транспорта
                if DistanceESPEnabled then
                    l_Drawing_0.Text = string.format("%s | %dm", Translate(l_Name_0), v331);
                else
                    l_Drawing_0.Text = Translate(l_Name_0);
                end;
                l_Drawing_0.Position = Vector2.new(v329.X, v329.Y); l_Drawing_0.Visible = true;
            else
...
l_l_v0_Window_0_Tab_1:CreateToggle({Name = "ATV", CurrentValue = false, Flag = "ATV_ESP", Callback = function(v332) EspEnabled.ATV = v332; end});
l_l_v0_Window_0_Tab_1:CreateToggle({Name = "Boat", CurrentValue = false, Flag = "Boat_ESP", Callback = function(v333) EspEnabled.Boat = v333; end});
l_l_v0_Window_0_Tab_1:CreateToggle({Name = "Helicopter", CurrentValue = false, Flag = "Heli_ESP", Callback = function(v334) EspEnabled.Helicopter = v334; end});
l_l_v0_Window_0_Tab_1:CreateToggle({Name = "Trolly", CurrentValue = false, Flag = "Trolly_ESP", Callback = function(v335) EspEnabled.Trolly = v335; end});
l_l_v0_Window_0_Tab_1:CreateToggle({Name = "Distance Esp", CurrentValue = false, Flag = "Vehicle_Distance_ESP", Callback = function(v336) DistanceESPEnabled = v336; end});

-- World Section 
local l_l_v0_Window_0_Tab_2 = l_v0_Window_0:CreateTab("World", nil);
local _ = l_l_v0_Window_0_Tab_2:CreateSection("Water");
local _ = l_l_v0_Window_0_Tab_2:CreateColorPicker({Name = "Water Color", Color = Color3.fromRGB(12, 84, 92), Flag = "ColorPicker1", Callback = function(v339) game.Workspace.Terrain.WaterColor = v339; end});
local _ = l_l_v0_Window_0_Tab_2:CreateToggle({Name = "Water Reflectance", CurrentValue = true, Flag = "Toggle1", Callback = function(v341) if v341 == true then game.Workspace.Terrain.WaterReflectance = 1; elseif v341 == false then game.Workspace.Terrain.WaterReflectance = 0; end; end});
local _ = l_l_v0_Window_0_Tab_2:CreateSlider({Name = "Water speed", Range = {1, 100}, Increment = 1, Suffix = "Speed", CurrentValue = 10, Flag = "Slider1", Callback = function(v343) game.Workspace.Terrain.WaterWaveSpeed = v343; end});
local _ = l_l_v0_Window_0_Tab_2:CreateSlider({Name = "Wave size", Range = {0, 1}, Increment = 0.1, Suffix = "Size", CurrentValue = 0.5, Flag = "Slider1", Callback = function(v345) game.Workspace.Terrain.WaterWaveSize = v345; end});
local _ = l_l_v0_Window_0_Tab_2:CreateSection("Clouds");
local _ = l_l_v0_Window_0_Tab_2:CreateColorPicker({Name = "Color Picker", Color = Color3.fromRGB(255, 255, 255), Flag = "ColorPicker1", Callback = function(v348) game.Workspace.Terrain.Clouds.Color = v348; end});
local _ = l_l_v0_Window_0_Tab_2:CreateSlider({Name = "Clouds", Range = {0, 1}, Increment = 0.1, Suffix = "Clouds", CurrentValue = 0.6, Flag = "Slider1", Callback = function(v350) game.Workspace.Terrain.Clouds.Cover = v350; end});
local _ = l_l_v0_Window_0_Tab_2:CreateSection("SkyBox");
local _ = l_l_v0_Window_0_Tab_2:CreateDropdown({
    Name = "Sky Changer", Options = {"Defalt", "Magma", "Water", "Obsidian", "Galaxy", "Void"}, CurrentOption = {"Defalt"}, MultipleOptions = false, Flag = "Dropdown1", 
    Callback = function(v353) 
        if type(v353) == "table" then v353 = v353[1]; end;
        local l_Lighting_0 = game:GetService("Lighting");
        for _, v356 in ipairs(l_Lighting_0:GetChildren()) do if v356:IsA("Sky") then v356:Destroy(); end; end;
        if v353 == "Defalt" then return; else
            ...
            if v359 then l_Sky_0.SkyboxBk = v359; l_Sky_0.SkyboxDn = v359; l_Sky_0.SkyboxFt = v359; l_Sky_0.SkyboxLf = v359; l_Sky_0.SkyboxRt = v359; l_Sky_0.SkyboxUp = v359; end;
            return;
        end;
    end
});
local _ = l_l_v0_Window_0_Tab_2:CreateSection("Other");
local _ = l_l_v0_Window_0_Tab_2:CreateToggle({Name = "Shadows", CurrentValue = true, Flag = "Toggle1", Callback = function(v362) game:GetService("Lighting").GlobalShadows = v362; end});
local _ = l_l_v0_Window_0_Tab_2:CreateToggle({Name = "Grass", CurrentValue = true, Flag = "GrassToggle", Callback = function(v364) setGrass(v364); end});
if not game:IsLoaded() then repeat task.wait(); until game:IsLoaded(); end;
local v366 = nil; repeat v366 = workspace:FindFirstChildOfClass("Terrain"); task.wait(); until v366;
setGrass = function(v367) 
    if not sethiddenproperty then warn("Your executor does not support sethiddenproperty"); return; else
        if not pcall(function() sethiddenproperty(v366, "Decoration", v367); end) then warn("Failed to change grass (Decoration property)"); end; return;
    end;
end;
setGrass(true);
local l_Workspace_2 = game:GetService("Workspace");
local v369 = {"Fir3_Leaves", "Elm1_Leaves", "Birch1_Leaves"};
local function v373(v370) 
    for _, v372 in ipairs(l_Workspace_2:GetDescendants()) do
        if v372:IsA("BasePart") and table.find(v369, v372.Name) then v372.Transparency = v370 and 0 or 1; v372.CanCollide = v370; end;
    end;
end;
local _ = l_l_v0_Window_0_Tab_2:CreateToggle({Name = "Tree Leaves", CurrentValue = true, Flag = "Toggle1", Callback = function(v374) v373(v374); end});
...
local function v387() 
    ...
    local v385 = tonumber(v382); local v386 = tonumber(v383); v384 = tonumber(v384);
    return v385 + v386 / 60 + v384 / 3600;
end;
l_RunService_3.RenderStepped:Connect(function() 
    if not v378 then l_Lighting_1.ExposureCompensation = 0; return; else
        local v388 = v387(); local v389 = 0;
        if v380 <= v388 or v388 < v381 then
            if v380 <= v388 then v388 = v388 - 24; end;
            if v388 < 0 then v389 = v379 * ((v388 + 3) / 3); else v389 = v379 * math.clamp(1 - v388 / v381, 0, 1); end;
        else v389 = 0; end;
        l_Lighting_1.ExposureCompensation = v389; return;
    end;
end);
local _ = l_l_v0_Window_0_Tab_2:CreateToggle({Name = "Bright Night", CurrentValue = false, Flag = "BrightNightToggle", Callback = function(v390) v378 = v390; if not v390 then l_Lighting_1.ExposureCompensation = 0; end; end});
local _ = l_l_v0_Window_0_Tab_2:CreateSection("Lighting");
local _ = l_l_v0_Window_0_Tab_2:CreateToggle({Name = "Lighting", CurrentValue = false, Flag = "Toggle1", Callback = function(v393) game:GetService("Lighting").StimEffect.Enabled = v393; end});
local _ = l_l_v0_Window_0_Tab_2:CreateColorPicker({Name = "TintColor", Color = Color3.fromRGB(255, 255, 255), Flag = "ColorPicker1", Callback = function(v395) game:GetService("Lighting").StimEffect.TintColor = v395; end});
local _ = l_l_v0_Window_0_Tab_2:CreateSlider({Name = "Brightness", Range = {0.1, 100}, Increment = 0.1, Suffix = "Brightness", CurrentValue = 0.1, Flag = "Slider1", Callback = function(v397) game:GetService("Lighting").StimEffect.Brightness = v397; end});
local _ = l_l_v0_Window_0_Tab_2:CreateSlider({Name = "Contrast", Range = {0, 20}, Increment = 0.1, Suffix = "Contrast", CurrentValue = 1, Flag = "Slider1", Callback = function(v399) game:GetService("Lighting").StimEffect.Contrast = v399; end});
local _ = l_l_v0_Window_0_Tab_2:CreateSlider({Name = "Saturation", Range = {0, 100}, Increment = 1, Suffix = "Saturation", CurrentValue = 10, Flag = "Slider1", Callback = function(v401) game:GetService("Lighting").StimEffect.Saturation = v401; end});
...
local v407 = false;
local v408 = {Enum.Material.Cobblestone, Enum.Material.WoodPlanks, Enum.Material.Metal, Enum.Material.CorrodedMetal};
local v409 = {};
local function v413(v410) for _, v412 in ipairs(v408) do if v412 == v410 then return true; end; end; return false; end;
local function v419(v414) 
        ...
        if v416:IsA("Model") then
            for _, v418 in ipairs(v416:GetDescendants()) do
                if v418:IsA("BasePart") and v413(v418.Material) then
                    if v414 then
                        if v409[v418] == nil then v409[v418] = v418.Transparency; end;
...
local _ = l_l_v0_Window_0_Tab_3:CreateKeybind({Name = "Xray", CurrentKeybind = "V", HoldToInteract = false, Flag = "Keybind1", Callback = function() v407 = not v407; v419(v407); end});
...
local v424 = 70; local v425 = 70; local v426 = 20; local v427 = false;
local _ = l_l_v0_Window_0_Tab_3:CreateKeybind({Name = "Zoom", CurrentKeybind = "X", HoldToInteract = true, Flag = "Zoom1", Callback = function(v428) v427 = v428; end});
local _ = l_l_v0_Window_0_Tab_3:CreateSlider({Name = "FOV Changer", Range = {50, 120}, Increment = 1, Suffix = "FOV", CurrentValue = v424, Flag = "Slider1", Callback = function(v430) v424 = v430; end});
...
local _ = l_l_v0_Window_0_Tab_3:CreateDropdown({Name = "Hit sound", Options = {"Default", "Rust", "Gamesense", "Magic", "Firework", "Lazer", "Pop", "Zap"}, CurrentOption = {"Default"}, MultipleOptions = false, Flag = "HitSoundDropdown", Callback = function(v442) local l_v442_0 = v442; if type(v442) == "table" then l_v442_0 = v442[1]; end; local l_PlayerHitHeadshot_0 = game:GetService("SoundService"):FindFirstChild("PlayerHitHeadshot"); if l_PlayerHitHeadshot_0 then l_PlayerHitHeadshot_0.SoundId = v441[l_v442_0] or v441.Default; l_PlayerHitHeadshot_0:Play(); end; end});
local _ = l_l_v0_Window_0_Tab_3:CreateSlider({Name = "Hit sound Volume", Range = {0.1, 5}, Increment = 0.1, Suffix = "Volume", CurrentValue = 1, Flag = "HitSoundVolume", Callback = function(v446) local l_PlayerHitHeadshot_1 = game:GetService("SoundService"):FindFirstChild("PlayerHitHeadshot"); if l_PlayerHitHeadshot_1 then l_PlayerHitHeadshot_1.Volume = v446; end; end});
local _ = l_l_v0_Window_0_Tab_3:CreateSection("Weapon Trail");
local _ = l_l_v0_Window_0_Tab_3:CreateColorPicker({Name = "Arrow Trailcolor", Color = Color3.fromRGB(255, 255, 255), Flag = "ColorPicker1", Callback = function(v450) local l_Trail_0 = game:GetService("ReplicatedStorage").Arrow:FindFirstChild("Trail"); if not l_Trail_0 then return; else l_Trail_0.Color = ColorSequence.new(v450); return; end; end});
local _ = l_l_v0_Window_0_Tab_3:CreateSlider({Name = "Arrow Trail lifespan", Range = {0.15, 20}, Increment = 0.1, Suffix = "s", CurrentValue = 0.15, Flag = "Slider1", Callback = function(v453) game:GetService("ReplicatedStorage").Arrow.Trail.Lifetime = v453; end});
l_RunService_3 = game:GetService("RunService");
...
local function v464(v456) 
    local v457 = {bullet = v456, points = {}};
    local v458 = nil;
    v458 = l_RunService_3.RenderStepped:Connect(function() 
        if not BulletTrailEnabled then return; elseif not v456 or not v456.Parent then v458:Disconnect(); return; else
            ...
            for v460 = 1, #v457.points - 1 do
                ...
                l_Part_2.Anchored = true; l_Part_2.CanCollide = false; l_Part_2.Size = Vector3.new(BulletTrailThickness, BulletTrailThickness, (v461 - v462).Magnitude);
                l_Part_2.CFrame = CFrame.new(v461, v462) * CFrame.new(0, 0, -l_Part_2.Size.Z / 2);
                l_Part_2.Color = BulletTrailColor; l_Part_2.Material = Enum.Material.ForceField; l_Part_2.Parent = l_Workspace_3;
...
local _ = l_l_v0_Window_0_Tab_3:CreateToggle({Name = "Bullet Trail", CurrentValue = false, Flag = "Toggle1", Callback = function(v466) BulletTrailEnabled = v466; end});
local _ = l_l_v0_Window_0_Tab_3:CreateColorPicker({Name = "Bullet Trail Color", Color = Color3.fromRGB(255, 255, 255), Flag = "ColorPicker1", Callback = function(v468) BulletTrailColor = v468; end});
local _ = l_l_v0_Window_0_Tab_3:CreateSlider({Name = "Trail Thickness", Range = {0.1, 1}, Increment = 0.1, Suffix = "Size", CurrentValue = 0.2, Flag = "Slider1", Callback = function(v470) BulletTrailThickness = v470; end});
local _ = l_l_v0_Window_0_Tab_3:CreateSlider({Name = "Bullet Trail Length", Range = {1, 25}, Increment = 1, Suffix = "Length", CurrentValue = 10, Flag = "Slider2", Callback = function(v472) BulletTrailLength = v472; end});
local _ = l_l_v0_Window_0_Tab_3:CreateSlider({Name = "Trail LifeTime", Range = {0.01, 5}, Increment = 0.01, Suffix = "LifeTime", CurrentValue = 0.1, Flag = "Slider3", Callback = function(v474) BulletTrailLifetime = v474; end});
local _ = l_l_v0_Window_0_Tab_3:CreateSection("Hand and Weapon Chams");
Player = game:GetService("Players").LocalPlayer;
local function v482(v477, v478) 
    local l_v477_0 = v477;
    for _, v481 in ipairs(v478) do
        if l_v477_0 then l_v477_0 = l_v477_0.FindFirstChild(l_v477_0, v481); end;
        if not l_v477_0 then return nil; end;
    end; return l_v477_0;
end;
local v483 = {}; local v484 = {}; local v485 = Color3.fromRGB(255, 255, 255);
local function v489() 
    v483 = {};
    for _, v487 in ipairs({{"Const", "Ignore", "FPSArms", "RightHand"}, {"Const", "Ignore", "FPSArms", "RightLowerArm"}, {"Const", "Ignore", "FPSArms", "LeftLowerArm"}, {"Const", "Ignore", "FPSArms", "LeftHand"}, {"Const", "Ignore", "FPSArms", "Fake", "c_RightLowerArm"}, {"Const", "Ignore", "FPSArms", "Fake", "c_LeftLowerArm"}}) do
        local v488 = v482(workspace, v487);
        if v488 and v488:IsA("BasePart") then table.insert(v483, v488); if not v484[v488] then v484[v488] = v488.Material; end; end;
    end;
end;
local function v500(v490) 
    if v490 == "Default" then for _, v492 in ipairs(v483) do if v492 and v492.Parent then v492.Material = v484[v492] or Enum.Material.Plastic; end; end; return; else
        local l_status_0, l_result_0 = pcall(function() return Enum.Material[v490]; end);
        if l_status_0 and l_result_0 then for _, v496 in ipairs(v483) do if v496 and v496.Parent then v496.Material = l_result_0; end; end; else
            for _, v498 in ipairs(v483) do do local l_v498_0 = v498; if l_v498_0 and l_v498_0.Parent then pcall(function() l_v498_0.MaterialVariant = v490; end); end; end; end;
            warn("'" .. tostring(v490) .. "' is not a valid Enum.Material; tried MaterialVariant instead.");
        end; return;
    end;
end;
v489();
Player.CharacterAdded:Connect(function(v501) local v502 = v501:WaitForChild("Const", 5); if v502 then v502:WaitForChild("Ignore", 5); end; end);
local l_l_l_v0_Window_0_Tab_3_Dropdown_1 = l_l_v0_Window_0_Tab_3:CreateDropdown({Name = "Hand", Options = {"Default", "ForceField", "Neon", "Asphalt"}, CurrentOption = {"Default"}, MultipleOptions = false, Flag = "Dropdown_HandMaterial", Callback = function(v503) local l_v503_0 = v503; if type(l_v503_0) == "table" then l_v503_0 = l_v503_0[1]; end; v489(); v500(l_v503_0); end});
local l_l_l_v0_Window_0_Tab_3_ColorPicker_2 = l_l_v0_Window_0_Tab_3:CreateColorPicker({Name = "Hand cham color", Color = v485, Flag = "ColorPicker_Hand", Callback = function(v506) v485 = v506; for _, v508 in ipairs(v483) do if v508 and v508.Parent then v508.Color = v506; end; end; end});
...
Player = game:GetService("Players").LocalPlayer; ReplicatedStorage = game:GetService("ReplicatedStorage");
local l_HandModels_0 = ReplicatedStorage:WaitForChild("HandModels");
local function v520(v513) 
    local v514 = {}; local v515 = {};
    local function v516(v517) 
        if v517:IsA("BasePart") then table.insert(v514, v517); if not v515[v517] then v515[v517] = v517.Material; end; end;
        for _, v519 in ipairs(v517:GetChildren()) do v516(v519); end;
    end;
    v516(v513); return v514, v515;
end;
local v521 = {}; local v522 = {};
local function v529() 
    v521 = {};
    for _, v524 in ipairs(l_HandModels_0:GetChildren()) do
        local v525, v526 = v520(v524); v521[v524] = v525;
        for v527, v528 in pairs(v526) do v522[v527] = v528; end;
    end;
end;
local function v546(v530) 
    if v530 == "Default" then
        for _, v532 in pairs(v521) do for _, v534 in ipairs(v532) do if v534 and v534.Parent then v534.Material = v522[v534] or Enum.Material.Plastic; end; end; end; return;
    else
        local l_status_1, l_result_1 = pcall(function() return Enum.Material[v530]; end);
        if l_status_1 and l_result_1 then for _, v538 in pairs(v521) do for _, v540 in ipairs(v538) do if v540 and v540.Parent then v540.Material = l_result_1; end; end; end; else
            for _, v542 in pairs(v521) do for _, v544 in ipairs(v542) do do local l_v544_0 = v544; if l_v544_0 and l_v544_0.Parent then pcall(function() l_v544_0.MaterialVariant = v530; end); end; end; end; end;
...
local _ = l_l_v0_Window_0_Tab_3:CreateDropdown({Name = "Weapon Chams", Options = {"Default", "ForceField", "Neon", "Asphalt"}, CurrentOption = {"Default"}, MultipleOptions = false, Flag = "Dropdown_WeaponMaterial", Callback = function(v553) local l_v553_0 = v553; if type(l_v553_0) == "table" then l_v553_0 = l_v553_0[1]; end; v529(); v546(l_v553_0); end});
local _ = l_l_v0_Window_0_Tab_3:CreateColorPicker({Name = "Weapon Cham Color", Color = Color3.fromRGB(255, 255, 255), Flag = "ColorPicker_Weapon", Callback = function(v556) v552(v556); end});
...
local _ = l_l_v0_Window_0_Tab_4:CreateKeybind({
    Name = "Free Cam", CurrentKeybind = "Z", HoldToInteract = false, Flag = "Keybind1", 
    Callback = function(_) 
        if FreeCamEnabled then
            ...
            if l_Character_0 then
                ...
                if l_Humanoid_0 then
                    if v564 then l_Humanoid_0.WalkSpeed = v564; end;
                    if v565 then l_Humanoid_0.JumpPower = v565; end;
                end;
            end;
        else
            FreeCamEnabled = true;
            ...
            if l_Character_1 then
                ...
                if l_Humanoid_1 then
                    v564 = l_Humanoid_1.WalkSpeed; v565 = l_Humanoid_1.JumpPower;
                    l_Humanoid_1.WalkSpeed = 0; l_Humanoid_1.JumpPower = 0;
                end;
            end;
...
local _ = l_l_v0_Window_0_Tab_4:CreateSlider({Name = "FreeCam Speed", Range = {1, 500}, Increment = 1, CurrentValue = 150, Flag = "Slider1", Callback = function(v582) FreeCamSpeed = v582; end});
l_UserInputService_3.InputBegan:Connect(function(v584, v585) if v585 then return; else if v566[v584.KeyCode] then v567[v584.KeyCode] = true; end; return; end; end);
...
SettingsTab:CreateButton({Name = "Unload Ocel-hub", Callback = function() v0:Destroy(); end});
return G2L["1"]
