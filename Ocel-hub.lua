...
local AntiAimPitch = "None"
local AntiAimYaw = "None"
...
local _ = l_l_v0_Window_0_Tab_0:CreateSection("Anti-Aim & Spinbot");
...
local _ = l_l_v0_Window_0_Tab_0:CreateDropdown({
    Name = "Pitch Mode",
    Options = {"None", "Down", "Up", "Zero"},
    CurrentOption = {"None"},
    MultipleOptions = false,
    Flag = "AntiAimPitchDropdown",
    Callback = function(valTable)
        AntiAimPitch = valTable[1]
    end
});

local _ = l_l_v0_Window_0_Tab_0:CreateDropdown({
    Name = "Yaw Mode",
    Options = {"None", "Jitter", "Backwards", "Left", "Right"},
    CurrentOption = {"None"},
    MultipleOptions = false,
    Flag = "AntiAimYawDropdown",
    Callback = function(valTable)
        AntiAimYaw = valTable[1]
    end
});
